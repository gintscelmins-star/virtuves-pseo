...
export const MATERIALU_APRAKSTI: Record<typeof MATERIALI[number], {
  ...
  mdf: {
    ...
    apstrade: 'EGGER MDF virsma ir gluda un ideāli piemērota krāsošanai — matēta, polēta vai ar poliurētāna krāsām. To viegli griezt, frēzēt un laminēt, nodrošinot precīzu apstrādi sarežgītākiem dizāiniem un dziļfrēzētām fasādēm.',
  ...
  koks: {
    nosaukums: 'Masīvkoks',
    ievads: 'Dabīgais koks ir aug stāklīmeņa izvēle klientiem, kas vēlas ilgstošu skaistumu, siltumu un ekolojišku pieeju savai virtuvei. Salīdzīnājumā ar MDF vai laminātu tas ir dārgākais variants, taču ilgtermiņā atmaksājas ar īstu kvalitāti un unikālu izskatu.',
    ...
    izturiba: 'Dabīgais koks, it īpaši termiski apstrādāts, labi iztur mitrumu, temperatūras svārstības un mehāniskus bojājumus. Pareiza lakošana vai eliļēšana nodrošina ilgstošu izturību pat virtuves mitrās zonās.',
    ...
    kapecIzvelaties: 'Dabīgais koks ir ideāls, ja vēlies mājīgu, unikālu un ekoloġisku virtuvi ar ilgstošu vērtību. Tā ir izvēle tiem, kas augstu vērtē autentiskumu un ir gatavi ieguldīt kvalitātē.',
    razotajs: 'Latvijas un Eiropas koka piegādātāji',
  },
  akrils: {
    nosaukums: 'Akrils',
    ievads: 'Akrils ir aug stāklīmeņa materiāls modernai virtuvei ar iespaidīgu efektu — dziļš spīdums vai matējums, antibakteriāls un viegli tīrāms. Ideāls klientiem, kas vēlas izsmalcinātu, mūsdienu dizāina virtuvi.',
    cenaKvalitate: 'Akrils ir aptuveni divas reizes dārgāks nekā MDF, taču sniedz nesalīdzīnāmi dziļāku spīdumu un ārkārtēju estētiku. Tā ir investicīja, kas izceļ virtuvi un paaugstina mājokļa vērtību.',
